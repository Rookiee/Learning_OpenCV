...
int main()
{
    ...
    cv::Mat image= cv::imread("/Users/Haoyang/Downloads/Pics/binaryGroup.bmp",0);
    if (!image.data)
        return 0;
    ...
    cv::Mat original= cv::imread("/Users/Haoyang/Downloads/Pics/group.jpg");
    ...
    image= cv::imread("/Users/Haoyang/Downloads/Pics/binaryGroup.bmp",0);
